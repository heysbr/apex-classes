      ...
      <div className="mx-12 text-shadow-lg/30">
        <div>
          ...
          <div>
            <a
              href="#"
              className="block sm:inline-block py-4 px-8 mb-4 mt-5 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-red-600 hover:bg-red-700 rounded"
            >
              Join Us
            </a>
          </div>
