...
export default function page() {
  return (
    <>
      <div>
        <section className="py-10 lg:py-20 text-black">
          <div className="container mx-auto px-4">
            <div className=" mx-auto">
              <div className="flex flex-wrap -mx-6">
                <div className="mb-6 px-6">
                  <span className=" px-6 m-4 h-80 float-right">
                    <img
                  ...
                  <p className="text-gray-500 leading-loose text-justify pt-2">
                    ...
                    which life presents to us at each coming moment. You don't
                  ...
                  <p className="text-gray-500 leading-loose text-justify">
                    ...
                    are testimony of our commitment to teaching. We strongly
