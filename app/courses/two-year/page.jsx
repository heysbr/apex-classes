...
export default function page() {
  return (
    <section class="py-20 text-black ">
      <h2 class="mb-10 text-3xl lg:text-4xl text-red-500 font-bold font-heading text-center ">
          ...
          <div class="bg-red-100 px-6 py-8 lg:flex-shrink-1 lg:p-12">
            ...
            <div class="mt-8">
              <div class="flex items-center">
                ...
                <h4 class="flex-shrink-0 px-4 text-sm leading-5 tracking-wider font-semibold uppercase text-indigo-600">
                  Course Structure
                </h4>
                <div class="flex-1 border-t-2 border-indigo-600"></div>
              </div>
